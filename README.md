...
Typical sources for CC0 assets include:
...
A small number of assets are licensed under Creative Commons Attribution (CC-BY). These assets permit use and modification provided the original creator is credited. All CC-BY assets used in the project are listed below with appropriate attribution.

"Holocron" (https://skfb.ly/orVw7) by brq327 is licensed under Creative Commons Attribution (http://creativecommons.org/licenses/by/4.0/).
